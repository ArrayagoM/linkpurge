...
- **Nombre Técnico:** QueryZero comunica la eliminación de los _Query Parameters_ (`?`) para llevarlos a cero.
...
- **Technical Name:** QueryZero conveys the removal of _Query Parameters_ (`?`) to bring them down to zero.
...
<html lang="es">
  <head>
    ...
    <meta
      name="description"
      content="QueryZero elimina automáticamente utm_source, fbclid y todos los parámetros de seguimiento. Ingeniería de precisión, rápido y privado."
    />
    <link rel="stylesheet" href="src/css/style.css" />
    <link
      rel="icon"
      href="data:image/svg+xml,<svg xmlns='[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)' viewBox='0 0 100 100'><text y='90' font-size='90'>🔗</text></svg>"
    />
  </head>
  <body>
    <header>
    ...
    <main>
      <section id="input-section">
        <textarea
          id="urlInput"
          placeholder="Pega aquí tu enlace largo y sucio (con utm_, fbclid, etc.)."
          rows="5"
        ></textarea>
